...
const data = Mock.mock('supermarket/home/multidata', 'get', {
  "banner":{
    ...
    "list":[
      ...
      {"acm":"3.mce.2_10_1jepe.43542.0.ccy5br4OlfK0T.pos_3-m_452733-sd_119",
        ...
        "title":"\u6d41\u884c\u62a2\u5148\u4e00\u6b65","width":750,"width923":750}],
    "nextPage":1},
  "recommend":{
    "context":{"currentTime":1538014774},"isEnd":true,
    "list":[{
...
const datas = Mock.mock('supermarket/home/data\?type=pop&page=1'|'supermarket/home/data\?type=new&page=1'|'supermarket/home/data\?type=sell&page=1', 'get', {
  "goods": {
    "pop":{
      "page": 0,
      "list|3": [{
